...
#									 #
# $Id: PG84-CentOS-x86.ks 1083 2009-12-21 03:29:07Z devrim $		 #
#									 #
##########################################################################
...
repo --name=a-base    --baseurl=ftp://ftp.linux.org.tr/centos/5/os/$basearch
repo --name=a-updates --baseurl=ftp://ftp.linux.org.tr/centos/5/updates/$basearch
repo --name=a-extras  --baseurl=ftp://ftp.linux.org.tr/centos/5/extras/$basearch
repo --name=a-live    --baseurl=http://www.nanotechnologies.qc.ca/propos/linux/centos-live/$basearch/live
repo --name=a-epel    --baseurl=ftp://ftp.linux.org.tr/epel/5/$basearch

# PGDG RPM Repository
repo --name=pgdg90  --baseurl=http://yum.pgrpms.org/9.0/redhat/rhel-5-i386
...
# add set no password for postgres user. It is already created with postgresql90-server RPM.
...
chkconfig postgresql-9.0 on 2>/dev/null
...
su -l postgres -c "/usr/pgsql-9.0/bin/initdb -D /var/lib/pgsql/9.0/data"
service postgresql-9.0 start

# Create pagila database and load pagila data into it:
su -l postgres -c "createdb pagila"
su -l postgres -c "psql pagila -f /usr/share/pagila90/pagila-schema.sql"
su -l postgres -c "psql pagila -f /usr/share/pagila90/pagila-data.sql"
...
Icon=/usr/share/pgadmin3_90/pgadmin3_90.xpm
Type=Application
