...
# add set no password for postgres user. It is already created with postgresql96-server RPM.
...
su -l postgres -c "psql pagila -f /usr/share/pagila96/pagila-schema.sql"
su -l postgres -c "psql pagila -f /usr/share/pagila96/pagila-data.sql"
...
Icon=/usr/share/pgadmin3_96/pgadmin3_96.xpm
Type=Application
...
Top=160
[frmMain]
Perspective-6930=layout2|name=objectBrowser;caption=Object browser;state=16779660;dir=4;layer=1;row=0;pos=0;prop=100000;bestw=200;besth=450;minw=100;minh=200;maxw=-1;maxh=-1;floatx=236;floaty=222;floatw=-1;floath=-1|name=listViews;caption=Info pane;state=1020;dir=5;layer=0;row=0;pos=0;prop=100000;bestw=400;besth=200;minw=200;minh=100;maxw=-1;maxh=-1;floatx=-1;floaty=-1;floatw=-1;floath=-1|name=sqlPane;caption=SQL pane;state=16779660;dir=3;layer=0;row=0;pos=0;prop=100000;bestw=400;besth=200;minw=200;minh=100;maxw=-1;maxh=-1;floatx=-1;floaty=-1;floatw=-1;floath=-1|name=toolBar;caption=Tool bar;state=16788208;dir=1;layer=10;row=0;pos=0;prop=100000;bestw=525;besth=44;minw=-1;minh=-1;maxw=-1;maxh=-1;floatx=-1;floaty=-1;floatw=-1;floath=-1|dock_size(5,0,0)=202|dock_size(3,0,0)=228|dock_size(1,10,0)=46|dock_size(4,1,0)=233|
[frmQuery]
MaxRows=100
MaxColSize=256
