...
%build
./configure --exec-prefix=%{pgpoolinstdir} --with-pgsql=%{pginstdir} --disable-static --with-pam --disable-rpath --sysconfdir=%{_sysconfdir}/%{name}/ --includedir=%{pgpoolinstdir}/include --datadir=%{pgpoolinstdir}/share --mandir=%{pgpoolinstdir}/man --with-openssl
...
#install -d %{pgpoolinstdir}/share/
cp -rp sample/ %{buildroot}/%{pgpoolinstdir}/share/
...
%{_sbindir}/update-alternatives --install /usr/bin/pgpool pgpool-pgpool %{pgpoolinstdir}/bin/pgpool 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_attach_node pgpool-pcp_attach_node %{pgpoolinstdir}/bin/pcp_attach_node 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_detach_node pgpool-pcp_detach_node %{pgpoolinstdir}/bin/pcp_detach_node 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_node_count pgpool-pcp_node_count %{pgpoolinstdir}/bin/pcp_node_count 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_node_info pgpool-pcp_node_info %{pgpoolinstdir}/bin/pcp_node_info 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_proc_count pgpool-pcp_proc_count %{pgpoolinstdir}/bin/pcp_proc_count 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_proc_info pgpool-pcp_proc_info %{pgpoolinstdir}/bin/pcp_proc_info 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_stop_pgpool pgpool-pcp_stop_pgpool %{pgpoolinstdir}/bin/pcp_stop_pgpool 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_recovery_node pgpool-pcp_recovery_node %{pgpoolinstdir}/bin/pcp_recovery_node 900
%{_sbindir}/update-alternatives --install /usr/bin/pcp_systemdb_info pgpool-pcp_systemdb_info %{pgpoolinstdir}/bin/cp_systemdb_info 900
%{_sbindir}/update-alternatives --install /usr/bin/pg_md5 pgpool-pg_md5 %{pgpoolinstdir}/bin/pg_md5 900
...
%changelog
* Tue Jul 03 2012 Devrim GÜNDÜZ <devrim@gunduz.org> - 3.0.7-2
- Update download URL.

* Tue Apr 24 2012 Devrim GUNDUZ <devrim@gunduz.org> - 3.0.7-1
- Update to 3.0.7
