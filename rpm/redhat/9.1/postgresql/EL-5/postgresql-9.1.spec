...
%config(noreplace) %attr (644,root,root) %{pgbaseinstdir}/share/postgresql-9.1-libs.conf
...
* Thu Aug 11 2016 Devrim Gündüz <devrim@gunduz.org> - 9.1.23-1PGDG
- Update to 9.1.23, per changes described at:
  http://www.postgresql.org/docs/9.1/static/release-9-1-23.html

* Wed May 11 2016 Devrim Gündüz <devrim@gunduz.org> - 9.1.22-1PGDG
- Update to 9.1.22, per changes described at:
  http://www.postgresql.org/docs/9.1/static/release-9-1-22.html

* Tue Mar 29 2016 Devrim Gündüz <devrim@gunduz.org> - 9.1.21-1PGDG
- Update to 9.1.21, per changes described at:
...
* Thu Jun 4 2015 Devrim Gündüz <devrim@gunduz.org> - 9.1.17-1PGDG
- Update to 9.1.17, per changes described at:
  http://www.postgresql.org/docs/9.1/static/release-9-1-17.html

* Tue May 19 2015 Devrim Gündüz <devrim@gunduz.org> - 9.1.16-1PGDG
- Update to 9.1.16, per changes described at:
  http://www.postgresql.org/docs/9.1/static/release-9-1-16.html

* Wed Feb 11 2015 Strahinja Kustudic <strahinjak@nordeus.com> - 9.1.15-2PGDG
- Remove obsolete /var/log/pgsql

* Tue Feb 3 2015 Devrim Gündüz <devrim@gunduz.org> - 9.1.15-1PGDG
- Update to 9.1.15, per changes described at:
...
* Fri Aug 29 2014 Devrim Gündüz <devrim@gunduz.org> - 9.1.14-2PGDG
- Add conditionals for uuid-ossp, to fix builds	when uuid is disabled.
  Patch	from Bernd Helmle.

* Tue Jul 22 2014 Devrim Gündüz <devrim@gunduz.org> - 9.1.14-1PGDG
- Update to 9.1.14, per changes described at:
  http://www.postgresql.org/docs/9.1/static/release-9-1-14.html

* Tue Mar 18 2014 Devrim Gündüz <devrim@gunduz.org> - 9.1.13-1PGDG
- Update to 9.1.13, per changes described at:
  http://www.postgresql.org/docs/9.1/static/release-9-1-13.html
- Fix permissions of postgresql-91-libs.conf, per Christoph Berg.

* Tue Feb 18 2014 Jeff Frost <jeff@pgexperts.com> - 9.1.12-1PGDG
- Update to 9.1.12, per changes described at:
