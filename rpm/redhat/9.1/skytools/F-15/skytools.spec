...
Source0:	http://pgfoundry.org/frs/download.php/2872/%{sname}-%{version}.tar.gz
...
%{pginstdir}/%{_lib}/python2.7/site-packages/skytools-2.1.12-py2.7.egg-info
%{pginstdir}/share/man/man1/bulk_loader.*
%{pginstdir}/share/man/man1/cube_dispatcher.*
%{pginstdir}/share/man/man1/londiste.*
%{pginstdir}/share/man/man1/pgqadm.*
%{pginstdir}/share/man/man1/queue_mover.*
%{pginstdir}/share/man/man1/queue_splitter.*
%{pginstdir}/share/man/man1/scriptmgr.*
%{pginstdir}/share/man/man1/skytools_upgrade.*
%{pginstdir}/share/man/man1/table_dispatcher.*
%{pginstdir}/share/man/man1/walmgr.*
%{pginstdir}/share/man/man5/londiste.*
