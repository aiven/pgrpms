...
BuildRequires:	postgresql%{pgmajorversion}-devel geos37-devel >= 3.6.2
BuildRequires:	pgdg-srpm-macros pcre-devel
%if 0%{?suse_version}
...
%changelog
* Mon Aug 17 2020 Devrim Gündüz <devrim@gunduz.org> - 2.3.11-1
- Update to 2.3.11
