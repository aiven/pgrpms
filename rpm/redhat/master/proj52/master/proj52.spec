%global sname proj
%global projinstdir /usr/%{sname}52
...
%changelog
* Thu Oct 25 2018 Devrim Gündüz <devrim@gunduz.org> - 0:5.2.0-1
- Initial build for yum.postgresql.org
