Name:		pgdg-redhat%{pgmajorversion}
Version:	%{pgmajorversion}
Release:	1
Summary:	PostgreSQL %{pgmajorversion}.X PGDG RPMs for RHEL - Yum Repository Configuration
Group:		System Environment/Base
License:	BSD
URL:		https://yum.postgresql.org
Source0:	https://yum.postgresql.org/RPM-GPG-KEY-PGDG-%{pgmajorversion}
Source2:	pgdg-%{pgmajorversion}-redhat.repo
