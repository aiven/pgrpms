...
Source0:	https://download.postgresql.org/pub/source/v%{pgmajorversion}beta1/%{sname}-%{pgmajorversion}beta1.tar.bz2
...
install -m 644 %{SOURCE14} %{buildroot}/etc/pam.d/%{sname}%{pgmajorversion}
%endif
...
cat initdb-%{pgmajorversion}.lang pg_ctl-%{pgmajorversion}.lang psql-%{pgmajorversion}.lang pg_dump-%{pgmajorversion}.lang pg_basebackup-%{pgmajorversion}.lang pg_rewind-%{pgmajorversion}.lang pg_upgrade-%{pgmajorversion}.lang pg_test_timing-%{pgmajorversion}.lang pg_test_fsync-%{pgmajorversion}.lang pg_archivecleanup-%{pgmajorversion}.lang pgscripts-%{pgmajorversion}.lang > pg_main.lst
