...
%if 0%{?rhel} && 0%{?rhel} == 6
# Revert a72c43012, as RHEL 6 uses Python 2.6. This patch is needed as of
# version 10.20.
Patch7:		%{sname}-%{pgmajorversion}-rhel6-revert-a72c43012.patch
%endif
...
%changelog
* Mon Apr 24 2023 Devrim Gunduz <devrim@gunduz.org> - 10.23-2PGDG.1
...
* Tue Aug 9 2022 Devrim Gündüz <devrim@gunduz.org> - 10.22-1PGDG
- Update to 10.22, per changes described at
...
* Fri Feb 18 2022 Devrim Gündüz <devrim@gunduz.org> - 10.20-2PGDG
- Rebuild on Fedora 34 because of LLVM and GCC updates.

* Tue Feb 8 2022 Devrim Gündüz <devrim@gunduz.org> - 10.20-1PGDG
- Update to 10.20, per changes described at
  https://www.postgresql.org/docs/release/10.20/
- Add a patch to revert a72c43012 on RHEL 6.
...
* Wed Aug 11 2021 Devrim Gündüz <devrim@gunduz.org> - 10.18-1PGDG
- Update to 10.18, per changes described at
