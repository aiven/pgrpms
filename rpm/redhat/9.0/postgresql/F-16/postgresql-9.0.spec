...
%description test
PostgreSQL is an advanced Object-Relational database management
system. The postgresql90-test package includes the sources and pre-built
...
# postgres user needs to own this file
...
* Tue Oct 12 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.0.1-2PGDG
...
- Mark init script as a config file, so changes made to it won't get lost during 
  updates or removals.

* Sat Oct 2 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.0.1-1PGDG
...
* Wed Sep 22 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.0.0-2PGDG
- Change pam file name, per bug report from Michael Best.

* Fri Sep 17 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.0.0-1PGDG
- Update to 9.0.0

* Fri Sep 10 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.0-rc1_2PGDG.1
...
* Sun Dec 20 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.5alpha3-1PGDG
