...
/sbin/ldconfig
# We now don't install file as we used to pre 9.0. Instead, use cat,
# so that package manager will be happy	during upgrade.
...
* Tue Dec 29 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.5alpha3-1PGDG
