...
%post
chkconfig --add slony1-90
if [ ! -e "/var/log/slony1-90" -a ! -h "/var/log/slony1-90" ]
then
        mkdir /var/log/slony1-90
        chown postgres:postgres /var/log/slony1-90
fi

%preun
if [ $1 = 0 ] ; then
	/sbin/service slony1-90 condstop >/dev/null 2>&1
	chkconfig --del slony1-90
fi

%postun
if [ $1 -ge 1 ]; then
	/sbin/service slony1-90 condrestart >/dev/null 2>&1
fi
