...
BuildRequires:	postgresql%{pgmajorversion}-devel, proj-devel, geos-devel, byacc, proj-devel, flex, sinjdoc, java, java-devel, ant
...
BuildRequires:	ant >= 0:1.6.2, junit >= 0:3.7, postgresql%{pgmajorversion}-jdbc
...
%post
%{_sbindir}/update-alternatives --install /usr/bin/pgsql2shp postgis-pgsql2shp %{pginstdir}/bin/pgsql2shp 900
%{_sbindir}/update-alternatives --install /usr/bin/shp2pgsql postgis-shp2pgsql %{pginstdir}/bin/shp2pgsql 900
...
* Sat May 19 2012 Devrim GUNDUZ <devrim@gunduz.org> - 1.5.4-1
- Update to 1.5.4.         

* Thu Aug 11 2011 Devrim GUNDUZ <devrim@gunduz.org> - 1.5.3-2
- Fix error in uninstall, per report from Pete Deffendol.

* Tue Aug 09 2011 Devrim GUNDUZ <devrim@gunduz.org> - 1.5.3-1
- Update to 1.5.3, per #55.
...
* Wed Oct 6 2010 Devrim GUNDUZ <devrim@gunduz.org> - 1.5.2-1
- Update to 1.5.2, and refactor spec file for PostgreSQL 9.0 RPMs.
