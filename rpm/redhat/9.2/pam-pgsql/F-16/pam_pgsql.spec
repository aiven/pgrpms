...
Version:	0.7.3.1
Release:	1%{dist}
Source0:	http://easynews.dl.sourceforge.net/sourceforge/pam-pgsql/pam-pgsql-%{version}.tar.gz
...
%{_sbindir}/update-alternatives --install /usr/lib/security/pam_pgsql.la pam-pgsql-la %{pginstdir}/lib/security/pam_pgsql.la 920
%{_sbindir}/update-alternatives --install /usr/lib/security/pam_pgsql.so pam-pgsql-so %{pginstdir}/lib/security/pam_pgsql.so 920
