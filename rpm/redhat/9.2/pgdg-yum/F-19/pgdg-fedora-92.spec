...
Version:	9.2
Release:	7
Summary:	PostgreSQL 9.2.X PGDG RPMs for Fedora - Yum Repository Configuration
Group:		System Environment/Base
License:	BSD
URL:		http://yum.postgresql.org
Source0:	http://yum.postgresql.org/RPM-GPG-KEY-PGDG-92
Source2:	pgdg-92-fedora.repo
BuildRoot:	%{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
BuildArch:	noarch
Requires:	fedora-release
Obsoletes:	pgdg-fedora >= 9.2-0
...
%changelog
* Wed Oct 21 2015 Devrim Gündüz <devrim@gunduz.org> - 9.2-7
