...
postgresql92-server sub-package.
...
%description server
PostgreSQL is an advanced Object-Relational database management system (DBMS).
The postgresql92-server package contains the programs needed to create
...
%description contrib
The postgresql92-contrib package contains various extension modules that are
...
%description plperl
The postgresql92-plperl package contains the PL/Perl procedural language,
...
The postgresql92-plpython package contains the PL/Python procedural language,
which is an extension to the PostgreSQL database server.
...
%description test
The postgresql92-test package contains files needed for various tests for the
...
* Wed Nov 8 2017 Devrim Gündüz <devrim@gunduz.org> - 9.2.24-1PGDG
- Update to 9.2.24, per changes described at:
  http://www.postgresql.org/docs/9.2/static/release-9-2-24.html

* Tue Aug 29 2017 Devrim Gündüz <devrim@gunduz.org> - 9.2.23-1PGDG
- Update to 9.2.23, per changes described at:
...
* Tue May 9 2017 Devrim Gündüz <devrim@gunduz.org> - 9.2.21-1PGDG
- Update to 9.2.21, per changes described at:
...
* Thu Jun 4 2015 Devrim Gündüz <devrim@gunduz.org> - 9.2.12-1PGDG
- Update to 9.2.12, per changes described at:
  http://www.postgresql.org/docs/9.2/static/release-9-2-12.html

* Tue May 19 2015 Devrim Gündüz <devrim@gunduz.org> - 9.2.11-1PGDG
- Update to 9.2.11, per changes described at:
  http://www.postgresql.org/docs/9.2/static/release-9-2-11.html

* Wed Feb 11 2015 Strahinja Kustudic <strahinjak@nordeus.com> - 9.2.10-2PGDG
...
* Tue Jul 22 2014 Devrim Gündüz <devrim@gunduz.org> - 9.2.9-1PGDG
- Update to 9.2.9, per changes described at:
