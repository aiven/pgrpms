...
# Copyright 2003-2011 Lamar Owen and Devrim Gunduz                     
# and others listed.
...
%changelog
* Wed Dec 5 2012 Devrim GUNDUZ <devrim@gunduz.org> 8.3.22-1PGDG
- Update to 8.3.22, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-22.html

* Sun Sep 23 2012 Devrim GUNDUZ <devrim@gunduz.org> 8.3.21-1PGDG
- Update to 8.3.21, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-21.html

* Thu Aug 16 2012 Devrim GUNDUZ <devrim@gunduz.org> 8.3.20-1PGDG
- Update to 8.3.20, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-20.html
  which also includes fixes for CVE-2012-3489 and CVE-2012-3488.

* Wed Jun 06 2012 Devrim GÜNDÜZ <devrim@gunduz.org> - 8.3.19-2PGDG
- Disable runselftest. We have buildfarm coverage already.

* Mon Jun 4 2012 Devrim GUNDUZ <devrim@gunduz.org> 8.3.19-1PGDG
- Update to 8.3.19, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-19.html
  which also includes fixes for CVE-2012-2143, CVE-2012-2655.

* Sun Feb 26 2012 Devrim GUNDUZ <devrim@gunduz.org> 8.3.18-1PGDG
- Update to 8.3.18, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-18.html
  which also includes fixes for CVE-2012-0866, CVE-2012-0867 and
  CVE-2012-0868 .

* Mon Dec 5 2011 Devrim GUNDUZ <devrim@gunduz.org> 8.3.17-1PGDG
- Update to 8.3.17, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-17.html

* Sun Sep 25 2011 Devrim GUNDUZ <devrim@gunduz.org> 8.3.16-1PGDG
- Update to 8.3.16, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-16.html

* Fri Jan 28 2011 Devrim GUNDUZ <devrim@gunduz.org> 8.3.14-1PGDG
- Update to 8.3.14, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-14.html

* Wed Dec 15 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.3.13-1PGDG
- Update to 8.3.13, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-13.html

* Sat Oct 2 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.3.12-1PGDG
- Update to 8.3.12, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-12.html
  which also fixes CVE-2010-3433.

* Sat May 15 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.3.11-1PGDG
- Update to 8.3.11, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-11.html

* Fri Mar 12 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.3.10-1PGDG
- Update to 8.3.10, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3-10.html

* Thu Dec 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.9-1PGDG
- Update to 8.3.9, for various fixes described at
  http://www.postgresql.org/docs/8.3/static/release-8-3.9.html

* Thu Sep 3 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.8-1PGDG
- Update to 8.3.8

* Fri Mar 13 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.7-1PGDG
- Update to 8.3.7

* Fri Jan 30 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.6-1PGDG
- Update to 8.3.6

* Mon Jan 19 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.3.5-2PGDG
- Re-enable uuid support in 64 bit packages. The uuid packages in our 
repository are not broken.

* Fri Oct 31 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.5-1PGDG
- Update to 8.3.5

* Fri Sep 19 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.4-1PGDG
- Update to 8.3.4 
...
* Sat Apr 21 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.4-1PGDG
- Update to 8.2.4

* Wed Feb 7 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.3-1PGDG
- Update to 8.2.3
...
* Sat Feb 3 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.2-1PGDG
- Update to 8.2.2

* Fri Jan 12 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.1-2PGDG
- Split -pl subpackage into three new packages.

* Wed Jan 3 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.2.1-1PGDG
- Update to 8.2.1
- Fix 64-bit build problem when pgfts is enabled

* Sat Dec 16 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2.0-4PGDG
- Enable thread safety to be compatible with RH/FC RPMs.

* Sun Dec 10 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2.0-3PGDG
- Fix BuildRequires for tcl package, per pg #2813
- Add 8.2-A4 PDF again

* Tue Dec 5 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2.0-2PGDG
- We are not in beta; set beta to 0

* Sat Dec 2 2006 Devrim GUNDUZ <devrim@gunduz.org> 8.2.0-1PGDG
- Update to 8.2.0 
