...
Source5:	%{sname}-%{packageversion}-pg_config.h
...
%if %{systemd_enabled}
Source10:	%{sname}-%{packageversion}-check-db-dir
Source18:	%{sname}-%{packageversion}.service
Source19:	%{sname}-%{packageversion}-tmpfiles.d
%else
Source3:	%{sname}-%{packageversion}.init
%endif

Patch1:		%{sname}-%{packageversion}-rpm-pgsql.patch
Patch3:		%{sname}-%{packageversion}-logging.patch
Patch5:		%{sname}-%{packageversion}-var-run-socket.patch
Patch6:		%{sname}-%{packageversion}-perl-rpath.patch
...
%{__install} -m 700 %{SOURCE9} %{buildroot}%{pgbaseinstdir}/share/postgresql-%{majorversion}-libs.conf
...
%changelog
* Mon Apr 24 2023 Devrim Gunduz <devrim@gunduz.org> - 9.4.26-2PGDG.1
- Modernise %patch usage, which has been deprecated in Fedora 38

* Mon Dec 05 2022 Devrim Gündüz <devrim@gunduz.org> - 9.4.26-2PGDG
...
- Add openssl-libs dependency. Per John Harvey.
...
* Tue Aug 6 2019 Devrim Gündüz <devrim@gunduz.org> - 9.4.24-1PGDG
- Update to 9.4.24, per changes described at:
  https://www.postgresql.org/docs/9.4/static/release-9-4-24.html
...
* Mon May 6 2019 Devrim Gündüz <devrim@gunduz.org> - 9.4.22-1PGDG
- Update to 9.4.22, per changes described at:
  https://www.postgresql.org/docs/9.4/static/release-9-4-22.html
...
* Mon Feb 26 2018 Devrim Gündüz <devrim@gunduz.org> - 9.4.17-1PGDG
- Update to 9.4.17, per changes described at:
...
* Sun Jul 2 2017 Devrim Gündüz <devrim@gunduz.org> - 9.4.12-2PGDG
...
* Tue Mar 29 2016 Devrim Gündüz <devrim@gunduz.org> - 9.4.7-1PGDG
- Update to 9.4.7, per changes described at:
