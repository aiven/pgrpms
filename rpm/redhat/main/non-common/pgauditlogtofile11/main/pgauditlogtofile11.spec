...
Requires:	postgresql%{pgmajorversion}-server pgaudit11_%{pgmajorversion}
...
%if %llvm
%package llvmjit
Summary:	Just-in-time compilation support for pgauditlogtofile11
...
%description llvmjit
This packages provides JIT support for pgauditlogtofile11
%endif
