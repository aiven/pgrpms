...
%changelog
* Mon Apr 24 2023 Devrim Gunduz <devrim@gunduz.org> - 9.5.25-2PGDG.1
- Modernise %patch usage, which has been deprecated in Fedora 38

* Mon Dec 05 2022 Devrim Gündüz <devrim@gunduz.org> - 9.5.25-2PGDG
...
* Mon Nov 9 2020 Devrim Gündüz <devrim@gunduz.org> - 9.5.24-1PGDG
- Update to 9.5.24, per changes described at:
  https://www.postgresql.org/docs/devel/static/release-9-5-24.html
...
- Specify dependency on openssl-libs, per John Harvey.
