...
%if %llvm
%package llvmjit
Summary:	Just-in-time compilation support for pgaudit16
...
%description llvmjit
This packages provides JIT support for pgaudit16
%endif
...
%changelog
* Sat Jun 03 2023 Devrim Gunduz <devrim@gunduz.org> - 1.6.2-2.1
