...
Requires:	postgresql%{pgmajorversion}-server pgaudit13_%{pgmajorversion}
...
%changelog
* Sat Jun 03 2023 Devrim Gunduz <devrim@gunduz.org> - 1.5.7-1.1
...
- Update to 1.5.1
- Split llvmjit into its own package
