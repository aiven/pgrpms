...
%if %llvm
%package llvmjit
Summary:	Just-in-time compilation support for pgaudit15
...
%description llvmjit
This packages provides JIT support for pgaudit15
%endif
...
%changelog
* Sat Jun 03 2023 Devrim Gunduz <devrim@gunduz.org> - 1.5.2-2.1
