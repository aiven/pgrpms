...
%changelog
* Mon Oct 15 2018 Devrim Gündüz <devrim@gunduz.org> - 3.6.0-2.1
...
* Thu Apr 9 2015 Devrim Gündüz <devrim@gunduz.org> 3.4-1-1
- Update to 3.4.1
...
* Thu Dec 10 2009 Devrim Gündüz <devrim@gunduz.org> 2.3-1
- Update to 2.3

* Mon Mar 23 2009 Devrim Gündüz <devrim@gunduz.org> 2.2-1
- Update to 2.2
- Update spec and patches so that pgpoolAdmin works against pgpool 2.2

* Sun Jun 15 2008 Devrim Gündüz <devrim@gunduz.org> 2.1-beta1-1
- Update to 2.1 beta1

* Tue Oct 16 2007 Devrim Gündüz <devrim@gunduz.org> 1.0.0-9
- Fixed smarty error caused by wrong ownership
- Change php requires version for EL-4

* Thu Aug 16 2007 Devrim Gündüz <devrim@gunduz.org> 1.0.0-8
- Fix ownership problem of pgmgmt.conf

* Thu Aug 16 2007 Devrim Gündüz <devrim@gunduz.org> 1.0.0-7
- Fix httpd configuration file -- it was using wrong directory.

* Sat Jun 2 2007 Devrim Gündüz <devrim@gunduz.org> 1.0.0-6
- Fixes for bugzilla review #229323

* Tue Feb 20 2007 Devrim Gündüz <devrim@gunduz.org> 1.0.0-5
- Fixes for packaging guidelines of web apps.
- Fix ownership problems

* Mon Oct 02 2006 Devrim Gündüz <devrim@gunduz.org> 1.0.0-4
- chgrp and chmod pgpool-II conf files so that apache can write it.
- Change file ownership from apache to nobody.

* Tue Sep 26 2006 Devrim Gündüz <devrim@gunduz.org> 1.0.0-3
- Update patch1

* Tue Sep 26 2006 Devrim Gündüz <devrim@gunduz.org> 1.0.0-2
- Fix file ownership
- Update patch1

* Tue Sep 26 2006 Devrim Gündüz <devrim@gunduz.org> 1.0.0-1
- Initial build
