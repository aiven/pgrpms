...
Source0:	https://github.com/EnterpriseDB/%{sname}/archive/REL-4_0_0.tar.gz
Patch0:		%{sname}-makefile-pgxs.patch
URL:		https://github.com/EnterpriseDB/mongo_fdw
BuildRequires:	postgresql%{pgmajorversion}-devel, mongo-cxx-driver-devel
