...
Source10:	postgresql93-check-db-dir
...
%changelog
* Tue Nov 6 2018 Devrim Gündüz <devrim@gunduz.org> - 9.3.25-1PGDG
- Update to 9.3.25, per changes described at:
  https://www.postgresql.org/docs/9.3/static/release-9-3-25.html

* Thu Aug 9 2018 Devrim Gündüz <devrim@gunduz.org> - 9.3.24-1PGDG
- Update to 9.3.24, per changes described at:
  https://www.postgresql.org/docs/9.3/static/release-9-3-24.html

* Tue May 8 2018 Devrim Gündüz <devrim@gunduz.org> - 9.3.23-1PGDG
- Update to 9.3.23, per changes described at:
  https://www.postgresql.org/docs/9.3/static/release-9-3-23.html

* Mon Feb 26 2018 Devrim Gündüz <devrim@gunduz.org> - 9.3.22-1PGDG
- Update to 9.3.22, per changes described at:
  https://www.postgresql.org/docs/9.3/static/release-9-3-22.html

* Tue Feb 6 2018 Devrim Gündüz <devrim@gunduz.org> - 9.3.21-1PGDG
- Update to 9.3.21, per changes described at:
  https://www.postgresql.org/docs/9.3/static/release-9-3-21.html

* Tue Dec 12 2017 Devrim Gündüz <devrim@gunduz.org> - 9.3.20-5PGDG
- Revert TimeOutSec changes in unit file, because infinity is only
  valid in systemd >= 229.

* Mon Dec 11 2017 Devrim Gündüz <devrim@gunduz.org> - 9.3.20-4PGDG
- RHEL 6 only: Fix regression in init script. Fixes PostgreSQL bug
 #14957 and many other reports.

* Thu Dec 7 2017 John K. Harvey <john.harvey@crunchydata.com> - 9.3.20-3PGDG
- Fixes for CVE-2017-12172 (EL-6 only)
- Update TimeOutSec parameter to match systemd docs (EL-7 only)

* Wed Nov 29 2017 Devrim Gündüz <devrim@gunduz.org> - 9.3.20-2PGDG-1
...
* Tue Aug 29 2017 Devrim Gündüz <devrim@gunduz.org> - 9.3.19-1PGDG
- Update to 9.3.19, per changes described at:
  http://www.postgresql.org/docs/9.3/static/release-9-3-19.html
...
* Tue Feb 7 2017 Devrim Gündüz <devrim@gunduz.org> - 9.3.16-1PGDG
...
* Tue Oct 6 2015 Jeff Frost <jeff@pgexperts.com> - 9.3.10-1PGDG
- Update to 9.3.10, per changes described at:
  http://www.postgresql.org/docs/9.3/static/release-9-3-10.html

* Thu Jun 11 2015 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.3.9-1PGDG
- Update to 9.3.9, per changes described at:
  http://www.postgresql.org/docs/9.3/static/release-9-3-9.html

* Thu Jun 4 2015 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.3.8-1PGDG
- Update to 9.3.8, per changes described at:
...
* Wed Feb 11 2015 Strahinja Kustudic <strahinjak@nordeus.com> - 9.3.6-3PGDG
- Remove obsolete /var/log/pgsql

* Tue Feb 3 2015 Devrim GÜNDÜZ <devrim@gunduz.org> - 9.3.6-2PGDG
