...
Source3:	pgpool-II-%{pgmajorversion}.service
...
- Update versions in init script and unit file
- Fix file name list for alternatives in %%postun
- Use correct file name in chkconfig
- Remove useless sed command
