...
%changelog
* Fri Aug 12 2011 Devrim Gunduz <devrim@gunduz.org> 1.9.0-1
- Update to 1.9.0, per #65.

* Fri Aug 8 2008 Devrim Gunduz <devrim@gunduz.org> 0:1.6.2-2PGDG
...
* Sun Dec 30 2007 Devrim Gunduz <devrim@gunduz.org> 0:1.6.2-1PGDG
- Update to 1.6.2

* Mon Sep 3 2007 Devrim Gunduz <devrim@gunduz.org> 0:1.6.0-2PGDG
- Add {?dist} to release tag.

* Sun Feb 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:1.6.0-1PGDG
- Added postgresql-devel to buildrequires, per Stefan Kaltenbrunner
- Update to 1.6.0
- Update URLs

* Sat Oct 14 2006 Devrim Gunduz <devrim@gunduz.org> 0:1.5.2-5PGDG
- Rebuilt

* Sat Oct 14 2006 Devrim Gunduz <devrim@gunduz.org> 0:1.5.2-4PGDG
- strip .so file

* Sat Aug 12 2006 Devrim Gunduz <devrim@gunduz.org> 0:1.5.2-3PGDG
- Fixed rpmlint warnings and errors

* Mon Jul 10 2006 Devrim Gunduz <devrim@gunduz.org> 0:1.5.2-2PGDG
- Rebuilt for PostgreSQL 8.1

* Mon Jul 10 2006 Devrim Gunduz <devrim@gunduz.org> 0:1.5.2-1PGDG
