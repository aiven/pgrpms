...
* Mon Jun 2 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.3.603-2PGDG
- Fix F-8+ builds.

* Thu Jan 31 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.3.603-1PGDG
- Update to build 603 (first stable release for 8.3)

* Tue Jan 1 2008 Devrim Gunduz <devrim@gunduz.org> 0:8.3.602-2PGDG
- Updated gcj_support requires, per Fedora spec file
- Fix buildroot
- Cosmetic cleanup

* Tue Dec 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.3.602-1PGDG
- Update to build 602

* Sun Nov 4 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.3.601-1PGDG
- First cut for 8.3
- Removed unused section macro.

* Mon Sep 3 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.2.506-1PGDG
- Update to build 506
- Add {?dist} to release tag.

* Wed Apr 18 2007 Devrim Gunduz <devrim@gunduz.org> 0:8.2.505-1PGDG
- Update to build 505

* Sun Dec 3 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.2.504-1PGDG
- Update to 8.2 build 504

* Thu Oct 19 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.2.407-1PGDG
- Rebuilt for PostgreSQL 8.2

* Sat Oct 14 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.1.407-4PGDG
- Fixed more rpmlint warnings and errors

* Sat Aug 12 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.1.407-3PGDG
- Fixed rpmlint warnings and errors
- Renamed spec file to meet rpm guidelines

* Mon Jul 17 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.1.407-2PGDG
- Rebuilt for PostgreSQL 8.1

* Mon Jul 10 2006 Devrim Gunduz <devrim@gunduz.org> 0:8.1.407-1PGDG
