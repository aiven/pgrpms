...
install -m 755 redhat/slony1.init %{buildroot}%{_initrddir}/slony1-II
...
* Fri Nov 19 2010 Devrim Gunduz <devrim@gunduz.org> 2.0.6.rc1-1
- Update to 2.0.6.rc1

* Tue Nov 16 2010 Devrim Gunduz <devrim@gunduz.org> 2.0.5-1
- Update to 2.0.5
- Remove obsolete patch

* Mon Sep 13 2010 Devrim Gunduz <devrim@gunduz.org> 2.0.4-1
- Update to 2.0.4
- Add a post-2.0.4 patch to fix groff detection.
- Remove 2.0.3 specific doc patch.
