...
# Copyright 2003-2011 Lamar Owen and Devrim GÜNDÜZ <devrim@gunduz.org>
# and others listed.
...
Source12:	http://www.postgresql.org/files/documentation/pdf/8.4/postgresql-8.4-A4.pdf
...
* Thu Sep 08 2011 Devrim GÜNDÜZ <devrim@gunduz.org> - 8.4.8-2PGDG
...
* Sat Oct 2 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.4.5-1PGDG
- Update to 8.4.5, for various fixes described at
  http://www.postgresql.org/docs/8.4/static/release-8-4-5.html
  which also fixes CVE-2010-3433.

* Mon Jun 14 2010 Devrim GÜNDÜZ <devrim@gunduz.org> - 8.4.4-2PGDG
- Own two more directories, per a recent thread in mailing lists.

* Fri May 14 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.4.4-1PGDG
- Update to 8.4.4, for various fixes described at
  http://www.postgresql.org/docs/8.4/static/release-8-4-4.html

* Fri Mar 12 2010 Devrim GUNDUZ <devrim@gunduz.org> 8.4.3-1PGDG
- Update to 8.4.3, for various fixes described at
  http://www.postgresql.org/docs/8.4/static/release-8-4-3.html

* Thu Dec 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4.2-1PGDG
- Update to 8.4.2, for various fixes described at 
  http://www.postgresql.org/docs/8.4/static/release-8-4-2.html

* Thu Sep 3 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4.1-1PGDG
- Update to 8.4.1

* Sat Jun 27 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4.0-1PGDG
- Update to 8.4.0

* Tue Jun 23 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4rc2-1PGDG
- Update to 8.4 rc2

* Sun Jun 14 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4rc1-1PGDG
- Update to 8.4 rc1   

* Sat May 16 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4beta2-1PGDG
- Update to 8.4 beta2

* Fri Apr 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4beta1-1PGDG
- Update to 8.4 beta1
- Remove buildrhel3 macro

* Fri Mar 27 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20090327-1PGDG
- Update to Mar 27 2009 CVS snapshot

* Tue Mar 10 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20090310-1PGDG
- Update to Mar 10, 2009 CVS snapshot

* Sat Feb 7 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20090207-1PGDG
- Update to Feb 7, 2009 CVS snapshot

* Fri Jan 23 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20090123-1PGDG
- Update to Jan 23, 2009 CVS snapshot

* Mon Jan 5 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20090105-1PGDG
- Update to Jan 5, 2009 CVS snapshot

* Mon Dec 29 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20081229-1PGDG
...
* Thu Dec 4 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20081204-1PGDG
- Update to Dec 04, 2008 CVS snapshot

* Fri Nov 28 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20081128-1PGDG
- Update to Nov 28, 2008 CVS snapshot

* Wed Nov 26 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20081126-1PGDG
- Update to Nov 26, 2008 CVS snapshot

* Wed Nov 19 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20081119-1PGDG
- Update to Nov 19, 2008 CVS snapshot, to test auto-contrib module.

* Tue Nov 18 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_20081118-1PGDG
...
* Thu Nov 13 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_13112008-1PGDG
- Update to Nov 13  2008 CVS snapshot

* Sat Oct 11 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_11102008-1PGDG
- Update to Oct 11 2008 CVS snapshot
- Add plpgsql translations.

* Mon Sep 29 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_29092008-1PGDG
- Update to Sep 29 2008 CVS snapshot

* Mon Sep 15 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_15092008-1PGDG
- Update to Sep 15 2008 CVS snapshot

* Mon Sep 8 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_07092008-2PGDG
- Use intdatetimes macro properly.

* Sun Sep 7 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_07092008-1PGDG
- Update to Sep 7 2008 CVS snapshot 

* Fri Sep 5 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_03092008-2PGDG
- Enable integer datetimes by default. This is a 8.4+ change.

* Wed Sep 3 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.4devel_03092008-1PGDG
...
* Fri Aug 8 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.3-2PGDG
...
* Mon Jun 9 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.3-1PGDG
- Update to 8.3.3 (8.3.2 was skipped by upstream)
- Re-enable uuid for F-9

* Thu Mar 13 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.1-2PGDG
...
* Thu Mar 13 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.1-1PGDG
- Update to 8.3.1

* Tue Feb 5 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.0-2PGDG
- Enable the new GSSAPI support in 8.3, per reminder from Tom.

* Fri Feb 1 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3.0-1PGDG
- Update to 8.3.0 
...
* Tue Jan 29 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3RC2-2PGDG
- Fix xml builds -- it was broken since first 8.3 package was built. 
  Per report from Steve Woodcock.

* Fri Jan 18 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3RC2-1PGDG
- Update to 8.3 RC2

* Thu Jan 3 2008 Devrim GUNDUZ <devrim@gunduz.org> 8.3RC1-1PGDG
...
* Thu Dec 06 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta4-2PGDG
- Set uuid default to 0. RHEL 4 does not have uuid package. RHEL 5 has 
  in EPEL repository. 

* Sun Dec 02 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta4-1PGDG
- Update to beta4
- Fix uuid builds

* Sun Nov 16 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta3-1PGDG
- Update to beta3
- Trim changelog.

* Sun Nov 04 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta2-3PGDG
- Added a new macro for --enable-integer-datetimes. It is disabled by default.

* Tue Oct 30 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta2-2PGDG
- Add a macro for contrib/uuid-ossp and set it to 1

* Sat Oct 26 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta2-1PGDG
...
* Mon Oct 15 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta1-4PGDG
- Build requires perl-devel, per failure on ppc64 builds.

* Wed Oct 10 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta1-3PGDG
...
* Mon Oct 8 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta1-2PGDG
- Added dist macro 

* Fri Oct 5 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3beta1-1PGDG
- Update to 8.3beta1
- Updates to spec file for 8.3 changes

* Tue Jun 5 2007 Devrim GUNDUZ <devrim@gunduz.org> 8.3devel-1PGDG
