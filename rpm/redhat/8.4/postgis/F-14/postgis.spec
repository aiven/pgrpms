...
* Wed Dec 1 2010 - Devrim GÜNDÜZ <devrim@gunduz.org> - 1.5.2-1
- Update to 1.5.2

* Thu May 27 2010 - Devrim GÜNDÜZ <devrim@gunduz.org> - 1.5.1-1
- Update to 1.5.1
- Add shp2pgsql-{cli-gui} among installed files.
- Spec file cleanups.

* Sat Mar 13 2010 Devrim GUNDUZ <devrim@gunduz.org> - 1.4.2-1
- Update to 1.4.2

* Thu Dec 17  2009 Devrim GUNDUZ <devrim@gunduz.org> - 1.4.1-1
- Update to 1.4.1

* Mon Jul 27 2009 Devrim GUNDUZ <devrim@gunduz.org> - 1.4.0-1
- Release 1.4.0

* Sat Jul 4 2009 Devrim GUNDUZ <devrim@gunduz.org> - 1.4.0rc1-1
- Update to 1.4.0rc1
- Fix spec for 1.4

* Tue Jun 2 2009 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.6-2
- Add a new subpackage: -docs, and add postgis pdf file to it.
- Update license.
- Fix some very minor rpmlint problems.

* Mon May 4 2009 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.6-1
- Update to 1.3.6

* Tue Dec 16 2008 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.5-1
- Update to 1.3.5

* Sat Nov 29 2008 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.4-1
- Update to 1.3.4

* Mon Aug 11 2008 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.3-2
- Fix #451387. Patch from Toshio.

* Sun Apr 13 2008 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.3-1
- Update to 1.3.3

* Sat Jan 5 2008 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.2-2
...
* Thu Dec 6 2007 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.2-1
- Update to 1.3.2
- Updated patch2

* Wed Nov 21 2007 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.1-2
- Move postgresql-jdbc dependency to the correct place, per Rob Nagler.

* Tue Oct 16 2007 Devrim GUNDUZ <devrim@gunduz.org> - 1.3.1-1
- Update to 1.3.1
- Updated patch2
...
* Mon Jul 2 2007 - Devrim GUNDUZ <devrim@gunduz.org> 1.2.1-2
- Fix build problems (removed template_gis, per discussion with upstream).

* Mon Feb 19 2007 - Devrim GUNDUZ <devrim@gunduz.org> 1.2.1-1
- Update to 1.2.1
...
* Wed Jan 3 2007 - Devrim GUNDUZ <devrim@gunduz.org> 1.2.0-4
- Added postgis.so among installed files, per Jon Burgess.
- Fix jdbc jar dedection problem

* Wed Dec 27 2006 - Devrim GUNDUZ <devrim@gunduz.org> 1.2.0-3
- Fix Requires for subpackages per bugzilla review #220743

* Mon Dec 26 2006 - Devrim GUNDUZ <devrim@gunduz.org> 1.2.0-2
- More spec file fixes per bugzilla review #220743

* Mon Dec 25 2006 - Devrim GUNDUZ <devrim@gunduz.org> 1.2.0-1
- Initial submission for Fedora Core Extras
- Spec file changes and fixes per FC Extras packaging guidelines

* Fri Jun 23 2006 - Devrim GUNDUZ <devrim@gunduz.org> 1.1.2-2
- Update to 1.1.2

* Tue Dec 22 2005 - Devrim GUNDUZ <devrim@gunduz.org> 1.1.0-2
