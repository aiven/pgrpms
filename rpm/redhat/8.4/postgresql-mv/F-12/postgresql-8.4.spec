...
# Copyright 2003-2009 Devrim GÜNDÜZ <devrim@gunduz.org>
# and others listed.
...
Source12:	http://www.postgresql.org/files/documentation/pdf/%{majorversion}/postgresql-%{version}-A4.pdf
...
%post
alternatives --install /usr/bin/psql psql /usr/pgsql-8.4/bin/psql 850
...
%postun
alternatives --remove psql /usr/pgsql-8.4/bin/psql
...
%changelog
* Tue Aug 25 2009 Devrim GUNDUZ <devrim@gunduz.org> 8.4.0-1PGDGMV
- Initial cut for 8.4 for multiple version installation.
