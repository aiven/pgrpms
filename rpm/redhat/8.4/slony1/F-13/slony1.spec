...
Patch0:		slony1-2.0.6-sgml.patch
...
%changelog
* Fri Dec 17 2010 Devrim GUNDUZ <devrim@gunduz.org> 2.0.6-2
- Update perl patch to ignore perl-log dependency.

* Sun Dec 5 2010 Devrim Gunduz <devrim@gunduz.org> 2.0.6-1
- Update to 2.0.6 
- Add a temp patch to fix sgml errors.
