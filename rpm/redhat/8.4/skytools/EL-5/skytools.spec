...
Source0:	http://pgfoundry.org/frs/download.php/2872/%{name}-%{version}.tar.gz
...
%changelog
* Wed Dec 1 2010 Devrim GUNDUZ <devrim@gunduz.org> - 2.1.12-1
- Update to 2.0.12

* Fri Mar 12 2010 Devrim GUNDUZ <devrim@gunduz.org> - 2.1.11-1
- Update to 2.0.11
...
* Wed Sep 2 2009 Devrim GUNDUZ <devrim@gunduz.org> 2.1.10-1
- Update to 2.1.10

* Fri Mar 13 2009 Devrim GUNDUZ <devrim@gunduz.org> 2.1.9-1
- Update to 2.1.9
- Remove pg84 patch, it	is now in upstream.

* Thu Mar 12 2009 Devrim GUNDUZ <devrim@gunduz.org> 2.1.8-1
- Update to 2.1.8
...
* Mon Jun 13 2008 - Devrim GUNDUZ <devrim@gunduz.org> 2.1.7-1
- Need to require python-psycopg v2, not v1.
- Update to 2.1.7

* Mon Jun 2 2008 - Devrim GUNDUZ <devrim@gunduz.org> 2.1.6-2
- Fix build for Fedora 9

* Sun Apr 6 2008 - Devrim GUNDUZ <devrim@gunduz.org> 2.1.6-1
- Update to 2.1.6
- Initial RPM packaging for yum.postgresql.org

* Mon Nov 19 2007 - Devrim GUNDUZ <devrim@gunduz.org> 2.1.5-1
- Update to 2.1.5

* Wed Nov 14 2007 - Devrim GUNDUZ <devrim@gunduz.org> 2.1.4-1
